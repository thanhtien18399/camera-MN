...
// import { fetchSignin } from '../util/actionAuthen'
import instance from '../../../api/instance'
import { checkTokenSignin } from '../util/actionAuthen'
   ...
   <Content className="signin">
            <Row gutter={[24, 0]} justify="space-around">
              ...
              <Col
                ...
                md={{ span: 12 }}
              >
                <img src={signinbg} alt="" style={{width:"80%",height:"90%"}} />
              </Col>
            </Row>
          </Content>
          <Footer>
